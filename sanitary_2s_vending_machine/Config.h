...
// the card edge.
#define CFG_TITLE_LINE_1       "MY"
#define CFG_TITLE_LINE_2       "ALL PURPOSE"
...
#define CFG_MACHINE_NAME       "Perfume Vending Machine"
...
// from MOTOR_PIN_POOL in Core_04_Hardware.ino, so 4 here means the first four
// pins of that pool. Maximum is the size of that pool.
#define CFG_MOTOR_COUNT        5
